                ...
                <div class="p-6 text-gray-900">
                    <div class="container mx-auto mt-5">
                        ...
                        <x-auth-session-status class="mb-4" :status="session('success')" />
                            ...
                            <div class="form-group">
                                <label for="informations" class="block text-sm font-medium text-gray-700">Information</label>
                                <textarea id="informations" name="informations" rows="3" class="block w-full p-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"></textarea>
                            </div>
