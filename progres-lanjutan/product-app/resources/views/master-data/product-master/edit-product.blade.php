<x-app-layout>
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <form action="{{ route('product-update', $product->id) }}" method="POST" class="p-6 bg-white rounded shadow-md">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="type" name="types" value="{{ old('type', $product->type) }}" required class="w-full p-2 mt-2 border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" id="qty" name="quantities" value="{{ old('qty', $product->qty) }}" required class="w-full p-2 mt-2 border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                </div>


                <div class="mb-6">
                    <label for="producer" class="block font-medium text-gray-700">Producer:</label>
                    <input type="text" id="producer" name="producers" value="{{ old('producer', $product->producer) }}" required class="w-full p-2 mt-2 border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                </div>
    ...
    {{-- SIZE : S, M , L , XL, XXL
    Bahan Puring : Tafeta 170
    Bahan Body: fleece, ( tebal kuat dan tidak berbulu)
    Bahan Tangan : Kulit sintetis


6.3‑inch OLED display with 2,622 x 1,206 resolution
